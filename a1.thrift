...
service BcryptService {
 ...
 bool registerBE (1: string hostName, 2: i16 portNumber) throws (1: IllegalArgument e);
 bool deregisterBE (1: string hostName, 2: i16 portNumber) throws (1: IllegalArgument e);
}
